...
{
    public readonly Location ToLocation() => Location.Create(FilePath, TextSpan, LineSpan);
...
/// non-cacheable Roslyn objects (a live <see cref="Location"/> roots the syntax tree / compilation).
/// </summary>
