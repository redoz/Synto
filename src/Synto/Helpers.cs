...
//    {
//        private static readonly NameSyntax _syntaxFactoryToken = SF.ParseName(typeof(SyntaxFactory).FullName);
...
//        public static ExpressionSyntax Accept<TNode>(this SyntaxList<TNode> nodeList,
//                                                                   CSharpSyntaxVisitor<ExpressionSyntax> visitor) where TNode : SyntaxNode
//        {
...
//        public static ExpressionSyntax Accept<TNode>(this SeparatedSyntaxList<TNode> nodeList,
//                                                                   CSharpSyntaxVisitor<ExpressionSyntax> visitor) where TNode : SyntaxNode
//        {
...
//                                             SF.IdentifierName(nameof(SyntaxKind)),
...
//        {
//            return expr ?? SF.LiteralExpression(SyntaxKind.NullLiteralExpression); // SyntaxFactoryInvocation(nameof(SF.Token), SyntaxKind.NullLiteralExpression.ToSyntaxKindLiteral());
//        }
