...
/// </summary>
/// <remarks>
/// This is a self-contained copy local to <c>Synto.Bootstrap</c>; the bootstrap generator deliberately
/// does not depend on the umbrella generator's (<c>Synto.SourceGenerator</c>) equatable models, mirroring
/// the same self-contained copy that lives in <c>Synto.Diagnostics</c>.
/// </remarks>
