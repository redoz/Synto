...
{
    public static MethodDeclarationSyntax Build(global::Microsoft.CodeAnalysis.CSharp.Syntax.ExpressionSyntax node)
    {
        ExpressionSyntax syntaxForParam_node = node.ToSyntax();
                                           ...
                                           SeparatedList<ArgumentSyntax>(
                                               new SyntaxNodeOrToken[] { 
                                                   Argument(
                                                       null, 
                                                       Token(None), 
                                                       global::MetaBuilders.Splice(node)) }), 
                                           Token(CloseParenToken))), 
