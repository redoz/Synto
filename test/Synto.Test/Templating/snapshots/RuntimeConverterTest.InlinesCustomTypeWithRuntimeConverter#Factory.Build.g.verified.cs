...
{
    public static MethodDeclarationSyntax Build(global::Color color, int count)
    {
        ExpressionSyntax syntaxForParam_color = global::ColorConverter.ToSyntax(color);
        ExpressionSyntax syntaxForParam_count = count.ToSyntax();
