...
{
    public static MethodDeclarationSyntax Build(global::Color color)
    {
        ExpressionSyntax syntaxForQuote_color = global::ColorConverter.ToSyntax(color);
