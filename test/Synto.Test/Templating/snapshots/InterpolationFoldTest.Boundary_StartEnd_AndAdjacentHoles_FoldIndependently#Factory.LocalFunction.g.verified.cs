...
{
    public static MethodDeclarationSyntax LocalFunction(string a, string b)
    {
        ExpressionSyntax syntaxForParam_a = a.ToSyntax();
        ExpressionSyntax syntaxForParam_b = b.ToSyntax();
                                                               ...
                                                               new InterpolatedStringContentSyntax[] { 
                                                                   InterpolatedStringText(
                                                                       Token(
                                                                           TriviaList(), 
                                                                           InterpolatedStringTextToken, 
                                                                           a.ToInterpolatedText() + b.ToInterpolatedText(), 
                                                                           a + b, 
                                                                           TriviaList())) }), 
                                                           Token(InterpolatedStringEndToken))) }), 
                                           Token(CloseParenToken))), 
