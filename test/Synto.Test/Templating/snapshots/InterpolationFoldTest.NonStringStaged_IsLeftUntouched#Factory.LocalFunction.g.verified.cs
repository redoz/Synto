...
{
    public static MethodDeclarationSyntax LocalFunction(int n)
    {
        ExpressionSyntax syntaxForParam_n = n.ToSyntax();
        var flag = true;
        ExpressionSyntax syntaxForStaged_flag = flag.ToSyntax();
